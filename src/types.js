...
export const FETCH_CLIENT_TYPES = "FETCH_CLIENT_TYPES";
export const CLIENT_TYPES_FETCHED = "CLIENT_TYPES_FETCHED";
export const ADD_CLIENT_TYPE_SUCCESS ="ADD_CLIENT_TYPE_SUCCESS";
export const ADD_CLIENT_TYPE_FAILED = "ADD_CLIENT_TYPE_FAILED";
